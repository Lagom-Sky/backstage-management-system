	...
	<div class="row-fluid">
		...
		<div class="span10">
			...
			<div class="data_list">
				...
				<form action="add/student/page.html" method="post">
					<div class="data_form">
						<table align="center">
							<tr>
								<td><font color="red">*</font>学生学号：</td>
								<td><input type="text" id="sno"  name="sno"  placeholder="请输入学号"  style="margin-top:5px;height:30px;" /></td>
							</tr>
							<tr>
								<td><font color="red">*</font>学生姓名：</td>
								<td><input type="text" id="name"  name="name"  placeholder="请输入姓名"  style="margin-top:5px;height:30px;" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" id="hometown"  name="hometown" placeholder="请输入籍贯"  style="margin-top:5px;height:30px;" /></td>
							</tr>
							<tr>
								<td><font color="red">*</font>入学日期：</td>
								<td><input type="date" id="enroldate" name="enroldate" lay-verify="date" placeholder="yyyy-MM-dd"  placeholder="请输入入学日期"  style="margin-top:5px;height:30px;" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" id="email"  name="email"  placeholder="请输入电子邮箱"  style="margin-top:5px;height:30px;" /></td>
							</tr>
							<tr>
								<td><font color="red">*</font>联系电话：</td>
								<td><input type="text" id="tel"  name="tel" placeholder="请输入联系电话"  style="margin-top:5px;height:30px;" /></td>
							</tr>
						</table>
						<div align="center">

	...
	<div class="row-fluid">
		...
		<div class="span10">
			...
			<div class="data_list">
				...
				<form action="add/admin/page.html" method="post">
					<div class="data_form">
						<table align="center">
							<tr>
								<td><font color="red">*</font>管理员名称：</td>
								<td><input type="text" id="username"  name="username" value="" placeholder="请输入管理员名称"  style="margin-top:5px;height:30px;" /></td>
							</tr>
							<tr>
								<td><font color="red">*</font>管理员密码：</td>
								<td><input type="text" id="password"  name="password" value="" placeholder="请输入管理员密码"  style="margin-top:5px;height:30px;" /></td>
							</tr>
							<tr>
								<td><font color="red">*</font>管理员姓名：</td>
								<td><input type="text" id="name"  name="name" value="" placeholder="请输入管理员姓名"  style="margin-top:5px;height:30px;" /></td>
							</tr>
							<tr>
								<td><font color="red">*</font>电子邮箱：</td>
								<td><input type="text" id="email"  name="email" value="" placeholder="请输入电子邮箱"  style="margin-top:5px;height:30px;" /></td>
							</tr>
							<tr>
